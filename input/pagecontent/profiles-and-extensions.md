...
<tbody>
  <tr>
    ...
    <td rowspan="3">Test example compliant with IPS and AU Core</td>
  ...
  <tr>
    <td rowspan="3">Test example compliant with AU Core but not IPS</td>
  ...
  <tr>
    <td rowspan="3">Test example compliant with IPS but not AU Core</td>
  ...
  <tr>
    <td rowspan="3"><br>Test example compliant with IPS but not AU Core</td>
  ...
  <tr>
    <td rowspan="3"><br>Test example compliant with AU Core but not IPS</td>
